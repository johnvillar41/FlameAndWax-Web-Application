...
namespace FlameAndWax.Services.Services.Interfaces
{
    public interface IProductsService
    {
        ...
        Task<PagedServiceResult<IEnumerable<CustomerReviewModel>>> FetchCustomerReviewsInAProduct(int pageNumber, int pageSize, int productId, string connectionString);        
